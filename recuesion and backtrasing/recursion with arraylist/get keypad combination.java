...
public class Main {
   ...
   static String[] kpc={".;","abc","def","ghi","jkl","mno","pqrs","tu","vwx","yz"};
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str=sc.next();
        ArrayList<String> al=getKPC(0,str);
    ...
    public static ArrayList<String> getKPC(int idx, String str) {
            ...
            ArrayList<String> al=getKPC(idx+1,str); // faith that
                // itwill give kepadpad combination from idx+1 to last 

            ArrayList<String> anser= new ArrayList();
            
            String str1=kpc[str.charAt(idx)-'0'];
